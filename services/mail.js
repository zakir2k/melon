x	var api_key = 'key-6d4aa2664b40bc0ae30e013655acf033';
var domain = 'mg.near.pro';
var mailgun = require('mailgun-js')({apiKey: api_key, domain: domain});
var from = 'Contact from Near<contact@near.pro>';

module.exports.sendContactEmail = function(email,cb){
...
  var welcomeEmail = "<h1>Hello</h1>";
	var data = {
    from: from,
    to: email,
    subject: 'Welcome to Near',
    html : welcomeEmail
  };
